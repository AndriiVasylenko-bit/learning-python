...
program reads the database and writes tile file (index.js)
...
...
12 records written to index.js
Open index.html to view the data in a browser

The file (index.html) consists of HTML and JavaScript to visualize
a Google Map.  It reads the most recent data in index.js to get
the data to be visualized.  Here is the format of the index.js file:
...
### 3. server.js
Run server.js where open local port: 3000
```
node server.js
```
Open browser in change 3000 prot